...
#' @description  This function finds the biclusters using the graph (gene-pairs file) and the genes-samples binary matrix generated by the \link[TuBAv2]{GenePairs} function.
#' @export
#' @param VariablePairs A character variable. Specifies the name of the gene-pairs .csv file generated by the \link[TuBAv2]{GenePairs} function.
#' @param BinaryMatrix A character variable. Specifies the name of the genes-samples binary matrix .csv file generated by the \link[TuBAv2]{GenePairs} function.
